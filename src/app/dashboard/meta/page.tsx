...
interface MetaRow { month: string; impressions: number; cost: number; }
interface ApiData { rows: MetaRow[]; totals: { cost: number; impressions: number }; }
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 overflow-hidden">
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-gray-800">
                {data.rows.length === 0 ? (
                  <tr><td colSpan={3} className="py-8 text-center text-gray-500">No data — add rows to the Meta tab</td></tr>
                ) : data.rows.map((r, i) => (

...
// Sheet layout: A=Month, B=Impressions, C=Clicks, D=Cost
...
export async function GET() {
  try {
    const rows = await getSheetData(SHEET_ID, "Pintrest!A2:D2000");
    ...
    return NextResponse.json({ rows: data, totals: { cost: totalCost, impressions: totalImpressions, clicks: totalClicks } }, {
